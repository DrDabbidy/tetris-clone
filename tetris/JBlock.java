...
{
    JBlock (int x, int y, Color color)
    {
        this.color = color;
        this.x = x;
        this.y = y;
        this.squares = new Square[][]{
            ...
            { new Square(0, 0, 25, this.color), null, null },
    ...
    JBlock (int x, int y, int squareLength, Color color)
    {
        this.color = color;
        this.x = x;
        this.y = y;
        this.squares = new Square[][]{
            ...
            { new Square(0, 0, squareLength, this.color), null, null },

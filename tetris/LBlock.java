...
{
    LBlock (int x, int y, Color color)
    {
        this.color = color;
        this.x = x;
        this.y = y;
        this.squares = new Square[][]{
            ...
            { null, null, new Square(2, 0, 25, this.color) },
    ...
    LBlock (int x, int y, int squareLength, Color color)
    {
        this.color = color;
        this.x = x;
        this.y = y;
        this.squares = new Square[][]{
            ...
            { null, null, new Square(2, 0, squareLength, this.color) },
